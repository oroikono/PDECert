...
| `atlas_evaluation.py` | Versioned per-record execution for typed symbolic and frozen-callable Atlas artifacts | Validate the full Atlas first; keep evidence per record and never aggregate unlike guarantees. |
